...
class Category_Wise_Search_Widget extends WP_Widget {
	...
	<input type="text" placeholder="Search for Answers" value="' . get_search_query() . '" name="s" id="s" />
    '.wp_dropdown_categories(apply_filters('widget_categories_dropdown_args', $cat_args)).'
	<input type="submit" id="searchsubmit"  placeholder="Search for Answers" value="'. esc_attr__('Search') .'" />
	</div>
	</form>';
