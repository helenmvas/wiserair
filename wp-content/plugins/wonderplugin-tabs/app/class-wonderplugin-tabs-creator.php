				...
				<form>
					<fieldset>
						...
						$skins = array(
								...
								"verticallefttabs" => "Vertocal Left Tabs",
						...
						<div class="wonderplugin-tabs-options-tab wonderplugin-tabs-options-tab-selected">
							...
							<table class="wonderplugin-form-table-noborder">
								...
								<tr>
									...
									<br />
									<label><input type="radio" name="wonderplugin-tabs-heightmode" value="auto"> Auto height - set minimun height (px): 
						...
						<div class="wonderplugin-tabs-options-tab">
							<table class="wonderplugin-form-table-noborder">
								...
								<tr>
									...
									<td><label><input name='wonderplugin-tabs-fullwidthtabsonsmallscreen' type='checkbox' id='wonderplugin-tabs-fullwidthtabsonsmallscreen'  /> Show tabs as full width when screen width is less than (px): 
										<input name="wonderplugin-tabs-fullwidthtabsonsmallscreenwidth" type="number" id="wonderplugin-tabs-fullwidthtabsonsmallscreenwidth" value="480" class="small-text" /></label>
									</td>
								</tr>
								...
								<tr>
									...
									<td>
										<label><input name='wonderplugin-tabs-triggerresize' type='checkbox' id='wonderplugin-tabs-triggerresize'  /> Trigger window resize event when switching tabs </label>
										<br><label><input name='wonderplugin-tabs-triggerresizeonload' type='checkbox' id='wonderplugin-tabs-triggerresizeonload'  /> Trigger window resize event <input name="wonderplugin-tabs-triggerresizeonloadtimeout" type="number" id="wonderplugin-tabs-triggerresizeonloadtimeout" value="0" class="small-text" /> milliseconds after tabs have inited </label>
