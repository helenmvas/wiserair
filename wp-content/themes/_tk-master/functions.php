...
function add_my_script() {
    wp_enqueue_script(
        'require', // name your script so that you can attach other scripts and de-register, etc.
        get_template_directory_uri() . '/includes/js/require.js', // this is the location of your script file
