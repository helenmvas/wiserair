	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12 col-md-12 text-center">
				...
				<div><?php echo do_shortcode('[wonderplugin_tabs id="71"]'); ?></div>
			</div>
		</div>
		<div class="row space">
			<div class="col-lg-12 col-md-12 text-center">
				<p><a href="#" class="button">Watch Our Installation Video</a> or <a href="#" class="button">View Complete Installation Guide</a></p>
			</div>
		</div>
	</div>
</section>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12 col-md-12 text-center">
				...
				<?php echo do_shortcode('[wonderplugin_tabs id="81"]'); ?>
			</div>
		</div>
	</div>
</section>
