...
$i++;
$cfg['Servers'][$i]['host']          = 'wiserairmlp-dev-sqlserver.database.windows.net'; // MySQL hostname or IP address
...
$cfg['Servers'][$i]['user']          = 'WiserTeam@wiserairmlp-dev-sqlserver';      // MySQL user
$cfg['Servers'][$i]['password']      = 'SEDevelopment1';          // MySQL password (only needed
